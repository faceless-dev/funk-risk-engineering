...
const SidebarSeparator = React.forwardRef<React.ElementRef<typeof Separator>, React.ComponentProps<typeof Separator>>(
    ({ className, ...props }, ref) => {
        return <Separator ref={ref} className={cn('mx-2 w-auto bg-sidebar-border', className)} data-sidebar="separator" {...props} />;
    },
);
...
const SidebarGroup = React.forwardRef<HTMLDivElement, React.ComponentProps<'div'>>(({ className, ...props }, ref) => {
    return <div ref={ref} className={cn('relative flex w-full min-w-0 flex-col p-2', className)} data-sidebar="group" {...props} />;
});
...
>(({ className, showIcon = false, ...props }, ref) => {
    ...
    return (
        <div ref={ref} className={cn('rounded-md h-8 flex gap-2 px-2 items-center', className)} data-sidebar="menu-skeleton" {...props}>
