...
import { Award, Building2, Calendar, Clock, Ruler, Shield, User, Users } from 'lucide-react';
            ...
            <Card>
                ...
                <CardContent className="p-6">
                    <div className="flex flex-wrap gap-3">
                        ...
                        {details.certifications.length === 0 && <div className="text-muted-foreground">Keine Zertifizierungen vorhanden</div>}
                    </div>
                </CardContent>
            </Card>
        </div>
