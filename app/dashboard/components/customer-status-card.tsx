      ...
      <CardHeader>
        <div className="space-y-1.5">
          ...
          <CardDescription className="text-sm text-muted-foreground">
            Kunden mit den meisten offenen Maßnahmen
          </CardDescription>
        </div>
      </CardHeader>
      <CardContent>
            ...
            >
              <div className="flex justify-between items-center">
                <div className="font-medium text-base flex items-center">
                  ...
                  />
                  <Link href={`/customers/${item.id}`} className="ml-2 hover:text-blue-600 hover:underline">
                    {item.customer}
                  </Link>
                </div>
              ...
              >
                ...
                {item.overdue > 0 && (
                  <motion.div
                    ...
                    transition={{ duration: 1, delay: 0.7 + 0.1 * index }}
                  >
                    {item.overdue}
                  </motion.div>
                )}
              ...
              <div className="flex text-xs text-muted-foreground">
                ...
                {item.overdue > 0 && (
                  <div className="flex items-center">
                    <div className="w-3 h-3 bg-rose-400 rounded-sm mr-1"></div>
                    Überfällig
                  </div>
                )}
              </div>
